...
const SITE = {
  ...
  "description": "Compra minoxidil Kirkland para barba y cabello con envio a todo Mexico por $140 fijo. Entregas personales gratis y pago contra entrega en CDMX. Paquetes de 1, 3, 6 y 12 meses, atencion por WhatsApp.",
  "theme": "mexico",
  "accent": "#137a45",
  "heroImage": "marcas-de-minoxidil.png",
  "location": "Envios a todo Mexico desde CDMX",
  "promise": "Envio nacional tarifa fija $140. Entregas personales gratis y pago contra entrega en CDMX. Paquetes claros, envio rastreable y asesoria practica antes de comprar.",
  ...
  "faq": [
    [
      ...
      "Si, enviamos a toda la Republica con tarifa fija de $140 MXN (FedEx/Estafeta/Redpack), incluyendo zonas extendidas como Michoacan (Buenavista CP 60700, Apatzingan CP 60600, Lazaro Cardenas CP 60950), Guerrero (Tlapa CP 41300, Ometepec CP 41700), Oaxaca (Pinotepa Nacional CP 71600, Juchitan CP 70000), Chiapas (Ocosingo CP 29950, Motozintla CP 30900) y Sierra de Chihuahua (Guachochi CP 33180) sin cargos adicionales. En CDMX y area metropolitana ofrecemos entregas personales gratis con pago contra entrega para tu seguridad."
    ],
    [
    ...
    [
      ...
      "Si. Envio nacional tarifa fija de $140 MXN a cualquier estado de la Republica. Manda ciudad y codigo postal para confirmar."
    ],
    [
...
const BUYER_STEPS = [
  ...
  ["03", "Manda ciudad", "Con ciudad y codigo postal se confirma envio nacional ($140 fijo) sin vueltas."],
...
const COVERAGE_AREAS = [
  "CDMX",
  "Estado de Mexico",
  "Michoacan (60700, 60600, 60950)",
  "Guerrero (41300, 41700)",
  "Oaxaca (71600, 70000)",
  "Chiapas (29950, 30900)",
  "Monterrey",
  "Guadalajara",
